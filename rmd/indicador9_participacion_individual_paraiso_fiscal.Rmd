...
Dado el porcentaje de participación individual con residencia en paraisos fiscales se calcula como el promedio de esta participación de los valores anuales en el periodo 20012-2014 para cada empresa.
...
$$PIBFPF\_1214_i =\sum_{t = 2012}^{2014} \frac{p_{ti}}{3}$$

Donde:

$p_{ti}$ : participación individual en paraísos fiscales de la empresa $i$ en el año $t$

$i$ : beneficiarios finales en paraísos fiscales

$PIBFPF\_1214_i$ : promedio de la participación individual de los beneficiarios finales con residencia en paraisos de las empresas durante el periodo **pre-reforma.**
...
Participación individual promedio que tuvieron las empresas en paraísos fiscales durante el periodo 2012-2014
