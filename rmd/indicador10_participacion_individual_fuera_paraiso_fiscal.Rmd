...
### Nombre del Indicador
 ...
 Participación individual de los beneficiarios finales fuera de paraísos fiscales

***

### Definición

Dado el porcentaje de participación individual de los beneficiarios finales fuera de paraísos fiscales, se calcula como el promedio de esta participación de los valores anuales en el periodo 20012-2014 para cada empresa.
...
$$PIBFFPF\_1214_i =\sum_{t = 2012}^{2014} \frac{p_{ti}}{3}$$

Donde:

$p_{ti}$ : participación individual de la empresa local $i$ en el año $t$

$i$ : beneficiarios finales fuera de paraísos fiscales

$PIBFFPF\_1214_i$ : promedio de la participación individual de los beneficiarios finales locales de las empresas durante el periodo **pre-reforma.**
...
Participación individual promedio que tuvieron las empresas que están fuera de paraísos fiscales durante el periodo 2012-2014
