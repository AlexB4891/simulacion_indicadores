...
Dado el porcentaje de participación de los beneficiarios finales locales, se calcula como el promedio de esta participación de los valores anuales en el periodo 20012-2014 para cada empresa.
...
$$PBFL\_1214_i =\sum_{t = 2012}^{2014} \frac{p_{ti}}{3}$$

Donde:

$p_{ti}$ : participación efectiva  de la empresa local $i$ en el año $t$

$i$ : beneficiarios finales en paraísos fiscales

$PBFL\_1214_i$ : promedio de la participación de los beneficiarios finales locales de las empresas durante el periodo **pre-reforma.**
...
Participación efectiva promedio que tuvieron las empresas locales durante el periodo 2012-2014
