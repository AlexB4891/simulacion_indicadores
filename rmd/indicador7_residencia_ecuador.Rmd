...
Dado el número de beneficiarios finales con residencia en Ecuador se calcula el promedio de los valores anuales en el periodo 20012-2014 para cada empresa.
...
$$NBFE\_1214_i =\sum_{t = 2012}^{2014} \frac{p_{ti}}{3}$$

Donde:

$N_{ti}$ : número de beneficiarios finales con residencia en Ecuador de la empresa $i$ en el año $t$

$i$ : beneficiarios finales con residencia en Ecuador

$NBFE\_1214_i$ : promedio del número de beneficiarios finales con residencia en Ecuador de las empresas durante el periodo **pre-reforma.**
...
Número de beneficiarios finales ´promedio con residencia en Ecuador durante el periodo 2012-2014
