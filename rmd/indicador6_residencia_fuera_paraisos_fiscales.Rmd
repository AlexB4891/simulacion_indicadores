...
Dado el número de beneficiarios finales con residencia fuera de paraisos fiscales o extranjeros se calcula como el promedio de los valores anuales en el periodo 20012-2014 para cada empresa.
...
$$NBFPFPF\_1214_i =\sum_{t = 2012}^{2014} \frac{N_{ti}}{3}$$

Donde:

$N_{ti}$ : número de beneficiarios finales con residencia fuera de paraisos fiscales o extranjeros de la empresa $i$ en el año $t$

$i$ : beneficiarios finales fuera de paraísos fiscales

$NBFPFPF\_1214_i$ : promedio del número de beneficiarios finales con residencia fuera de paraisos fiscales o extranjeros de las empresas durante el periodo **pre-reforma.**
...
* **Anexo APS:**
  ...
  * **Porcentaje efectivo de participacion**: es el porcentaje de propiedad en la empresa informante que tiene cada beneficiario final declarado o informado en el Anexo APS
...
Número de beneficiarios promedio que están fuera de paraísos fiscales durante el periodo 2012-2014
